...
- **index.md** -- a directory's table of contents: plain markdown, with an
  H1 and a description paragraph written by hand and the list below them
  generated by `clis/index-gen/generate_index.py` from the directory's
  members.
