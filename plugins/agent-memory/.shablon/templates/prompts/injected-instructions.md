...
and stop. system/ files are capped at {{ caps.system_file }} characters each and the whole
injection at {{ caps.injection }}, and the metadata below shows the spend; every character
