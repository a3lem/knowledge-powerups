...
Dropped work is a common source: "we decided not to do X because Y" outlives the work item it came from, and the item itself gets deleted (see /knowledge-powerups:docs-folder skill).
